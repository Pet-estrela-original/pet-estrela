...
const PlanCard = ({ plan }: { plan: Plan }) => {
    return (
        <div className="perspective group h-auto sm:h-[580px] md:h-[550px]">
            <div className="relative h-full w-full rounded-lg shadow-xl transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                {/* Front of card */}
                <div className="absolute inset-0 bg-white rounded-lg p-6 md:p-8 flex flex-col [backface-visibility:hidden]">
                    {plan.isMostChosen && (
                ...
                {/* Back of card */}
                <div className="absolute inset-0 bg-primary text-primary-foreground rounded-lg p-6 md:p-8 flex flex-col [transform:rotateY(180deg)] [backface-visibility:hidden]">
